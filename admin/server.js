...
app.use((req, res, next) => {
	...
	res.header("Access-Control-Allow-Origin", ALLOW_ORIGIN);//设置允许源
	res.header("Access-Control-Allow-Credentials", CREDENTIALS);//是否允许携带资源凭证（例如：cookie等）
	res.header("Access-Control-Allow-Headers", HEADERS);//允许的请求头信息
	res.header("Access-Control-Allow-Methods", ALLOW_METHODS);//允许的请求方法
